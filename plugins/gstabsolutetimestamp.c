 ...
 */
/**
 * SECTION:element-gstabsolutetimestamp
 *
 * The absolutetimestamp element does FIXME stuff.
 *
 * <refsect2>
 * <title>Example launch line</title>
 * |[
 * gst-launch-1.0 -v fakesrc ! absolutetimestamp ! FIXME ! fakesink
 * ]|
...
plugin_init (GstPlugin * plugin)
{
  ...
  return gst_element_register (plugin, "absolutetimestamp", GST_RANK_NONE,
      GST_TYPE_ABSOLUTETIMESTAMP);
}
